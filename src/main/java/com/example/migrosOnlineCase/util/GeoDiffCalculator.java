...
public class GeoDiffCalculator {
    ...
    public static double calculateDistanceHaversine(double lat1, double lng1, double lat2, double lng2) {
        //Haversine Formula
        final int R = 6371;
    ...
    public static double calculateDistanceVincenty(double latitude1, double longitude1, double latitude2, double longitude2) {
        //Vincenty’s Formula
